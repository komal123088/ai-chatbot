...
export const metadata: Metadata = {
  title: "Gemini AI Studio — Powered by Google Gemini",
  description: "Next-generation AI tools powered by Google Gemini. Chat, code generation, text summarization and more.",
};
